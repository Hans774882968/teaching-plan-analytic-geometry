        ...
        thinks: [
          {
            ...
            answer: String.raw`✅ 是偶函数。因为 $ f(-x) = (-x)^2 + 1 = x^2 + 1 = f(x) $，满足偶函数定义。`,
        ...
        thinks: [
          {
            ...
            answer: String.raw`✅ 是奇函数。因为 $ f(-x) = (-x)^3 - (-x) = -x^3 + x = -(x^3 - x) = -f(x) $，满足奇函数定义。`,
            answerRowMaxHeight: '100px',
          },
        ],
      },
        ...
        thinks: [
          {
            ...
            answer: String.raw`✅ 计算 $ f(2+x) = (2+x-2)^2 = x^2 $，$ f(2-x) = (2-x-2)^2 = (-x)^2 = x^2 $，所以 $ f(2+x) = f(2-x) $，即关于 $ x=2 $ 对称。`,
